    ...
    <div className="animate-[fade-in_1s_ease_both] py-8">
      <div className="mx-auto flex max-w-300 flex-row items-center justify-center px-4 min-[600px]:px-6">
        ...
        <div className="min-w-0 px-4">
          ...
          <div className="mb-4 flex items-center justify-center gap-3 min-[900px]:block">
            <h4 className="text-center text-[2.2rem] leading-[2.3rem] text-base-content min-[900px]:text-[2.5rem] min-[900px]:leading-[2.6rem]">
              Humble Beginnings
            </h4>

            {/* eslint-disable-next-line @next/next/no-img-element -- intrinsic size, no next/image equivalent needed here */}
            <img src={`${S3_BASE_URL}/bonus.png`} alt="Bonus" className="h-24 w-24 shrink-0 min-[900px]:hidden" />
          </div>
          ...
          <div className="flex flex-row flex-wrap items-center px-6">
            ...
            <div className="ml-auto w-1/2">
              ...
              <button
                type="button"
                onClick={onReveal}
                className="mx-auto mt-6 block cursor-pointer rounded bg-primary px-[2.4rem] py-4 text-[15px] font-medium text-white uppercase shadow-[0_4px_5px_-2px_rgba(0,0,0,0.2),0_7px_10px_1px_rgba(0,0,0,0.14),0_2px_16px_1px_rgba(0,0,0,0.12)] min-[600px]:mt-2.5"
              >
                Reveal
              </button>
            </div>
